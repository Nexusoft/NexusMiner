...
namespace gpu
{
	...
	void PrimeTests::sieve_performance_test()
	{
		...
		m_logger->info("Combined sieve ({:.1f} MISPS).", sieve_range / (sieve_elapsed_s + medium_small_sieve_elapsed_s + small_prime_sieve_elapsed_s + large_prime_sieve_elapsed_s) / 1e6);
